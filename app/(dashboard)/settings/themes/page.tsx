...
export default function SettingsThemesPage({ language = 'fr' }: SettingsThemesPageProps) {
  ...
  const handleUpgradeClick = () => {
    ...
    alert("Félicitations ! Vous venez de débloquer Floussi Elite pour 200 DH/mois. Vous pouvez maintenant personnaliser à l'infini.");
  };

  if (loading) {
    return <div className="text-center py-10 font-bold text-slate-400">Chargement des thèmes...</div>;
  }
    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-xl font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
          ...
          <span>Thèmes Marocains & Identité Visuelle</span>
        </h2>
